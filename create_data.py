...
##    im=cv2.imdecode(imgNp,-1)
    ...
    ospath=("C:/Users/Sachin Sehwag/Desktop/Multiplefacedetectionattendanceandwritingittoa file/datasets/",namas,"/",count,".png")
    ...
    if key == 27:
        break
count = 31
temp = input("Press any key and enter (for Specs)")
while count < 60: 
    (_, im) = webcam.read()
##    imgPath=urllib.urlopen(url)
##    imgNp=np.array(bytearray(imgPath.read()),dtype=np.uint8)
